...
/* ============================================================
   ...
   ============================================================ */
const INLINE_APPS = [
  { name:"al-dawah-fi-al-qarn", emoji:"📢", categories:["arabic"], badge:"dev", status:"beta", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"al-fasad-al-siyasi", emoji:"🏛", categories:["arabic"], badge:"dev", status:"beta", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"al-ghazali-library", emoji:"📚", categories:["arabic"], badge:"new", status:"dev", visibility:"public", tags:["HTML", "Islamic", "arabic", "web-app"],
  ...
  { name:"al-ghazw-al-thaqafi", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"al-ghirbal", emoji:"⛔", categories:["arabic"], badge:"dev", status:"beta", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"⛔ The Sieve — الغربال", fr:"Al Ghirbal — application éducative islamique trilingue.", ar:"الغربال" }},
  { name:"al-hayat-al-ula", emoji:"🌅", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"🌅 The First Life — الحياة الأولى", fr:"Al Hayat Al Ula — application éducative islamique trilingue.", ar:"الحياة الأولى" }},
  { name:"al-islam-al-muftara-alayh", emoji:"⚖", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"al-islam-fi-wajh-al-zahf", emoji:"🔴", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"al-islam-wa-qanun", emoji:"⚖", categories:["arabic"], badge:"dev", status:"beta", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"al-islam-wal-awda-al-iqtisadiyah", emoji:"💰", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"al-islam-wal-istibdad", emoji:"⚖", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"al-islam-wal-manahij", emoji:"🟠", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"al-istimar", emoji:"🏴", categories:["arabic"], badge:"dev", status:"beta", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"al-janib-al-atifi", emoji:"💗", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"al-mahawir-al-khamsah", emoji:"🔥", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"al-miraat", emoji:"🪞", categories:["arabic"], badge:"dev", status:"beta", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"🪞 The Mirror — المرآة", fr:"Al Miraat — application éducative islamique trilingue.", ar:"المرآة" }},
  { name:"al-saaiqa", emoji:"⛈", categories:["arabic"], badge:"dev", status:"beta", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"⛈️ The Thunderbolt — الصاعقة", fr:"Al Saaiqa — application éducative islamique trilingue.", ar:"الصاعقة" }},
  { name:"al-sunnah-al-nabawiyah", emoji:"📜", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"al-taassub-wal-tasamuh", emoji:"🕊", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"aqidat-al-muslim", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"🕌 عقيدة المسلم — The Muslim's Creed", fr:"Aqidat Al Muslim — application éducative islamique trilingue.", ar:"عقيدة المسلم" }},
  { name:"arabic-keyboard", emoji:"🕌", categories:["arabic"], badge:"new", status:"dev", visibility:"public", tags:["Islamic", "arabic"],
    desc:{ en:"Virtual Arabic keyboard for the browser — type Arabic anywhere.", fr:"Clavier arabe virtuel pour le navigateur — tapez en arabe partout.", ar:"لوحة مفاتيح عربية افتراضية للمتصفح — اكتب بالعربية في أي مكان." }},
  { name:"arabic-speaker", emoji:"🗣", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "arabic", "web-app"],
    desc:{ en:"🗣️ Arabic Speech App (Browser-Only)", fr:"Arabic Speaker — application Workshop-DIY.", ar:"تطبيق عربي وإسلامي تفاعلي من Workshop-DIY." }},
  ...
  { name:"ayqidh-taqatak", emoji:"⚡", categories:["arabic"], badge:"dev", status:"beta", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"cowsay", emoji:"🐄", categories:["learning"], badge:"new", status:"dev", visibility:"public", tags:["math", "ASCII-art", "fun-facts", "kids"],
  ...
  { name:"difaa-al-aqidah", emoji:"🛡", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"dustur-al-wahdah", emoji:"🤝", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"elarabya", emoji:"🕌", categories:["arabic"], badge:"new", status:"dev", visibility:"public", tags:["Islamic", "arabic"],
    desc:{ en:"Arabic language learning tools — grammar, vocabulary and exercises.", fr:"Outils d'apprentissage de la langue arabe — grammaire, vocabulaire et exercices.", ar:"أدوات تعلم اللغة العربية — قواعد، مفردات وتمارين." }},
  { name:"fan-al-dhikr", emoji:"🤲", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"fi-mawkib-al-dawa", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"fiqh-al-sirah", emoji:"📜", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"haqiqat-al-qawmiyah", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"hasad-al-ghurur", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"humum-daiya", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"هموم داعية — Concerns of a Preacher", fr:"Humum Daiya — application éducative islamique trilingue.", ar:"هموم داعية" }},
  { name:"huquq-al-insan", emoji:"⚖", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"⚖️ Human Rights — حقوق الإنسان", fr:"Huquq Al Insan — application éducative islamique trilingue.", ar:"حقوق الإنسان" }},
  { name:"ierab", emoji:"🕌", categories:["arabic"], badge:"new", status:"dev", visibility:"public", tags:["Islamic", "arabic"],
    desc:{ en:"Arabic grammar (I'rab) interactive exercises and lessons.", fr:"Exercices interactifs de grammaire arabe (I'rab) et leçons.", ar:"تمارين تفاعلية في الإعراب والنحو العربي." }},
  { name:"iyadat-al-ummah", emoji:"🩺", categories:["arabic"], badge:"dev", status:"beta", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"🩺 The Ummah Clinic — عيادة الأمة", fr:"Iyadat Al Ummah — application éducative islamique trilingue.", ar:"عيادة الأمة" }},
  { name:"jaddid-hayatak", emoji:"🌅", categories:["arabic"], badge:"dev", status:"beta", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"🌅 Renew Your Life — جدد حياتك", fr:"Jaddid Hayatak — application éducative islamique trilingue.", ar:"جدد حياتك" }},
  { name:"jihad-al-dawah", emoji:"🌿", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"kayfa-nafham", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"kayfa-nataamal-maa-al-quran", emoji:"📖", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"khuluq-al-muslim", emoji:"🌟", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"🌟 خلق المسلم — The Muslim's Character", fr:"Khuluq Al Muslim — application éducative islamique trilingue.", ar:"خلق المسلم" }},
  { name:"khutab-al-ghazali", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"خطب الغزالي — Ghazali's Sermons", fr:"Khutab Al Ghazali — application éducative islamique trilingue.", ar:"خطب الغزالي" }},
  { name:"kunuz-min-al-sunnah", emoji:"✨", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"maa-allah", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"🕌 With God — مع الله", fr:"Maa Allah — application éducative islamique trilingue.", ar:"مع الله" }},
  { name:"marakah-al-mushaf", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"miat-sual", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"min-huna-nalam", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"من هنا نعلم — This Is Where We Learn", fr:"Min Huna Nalam — application éducative islamique trilingue.", ar:"من هنا نعلم" }},
  { name:"mushkilat", emoji:"📖", categories:["tools"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "PWA", "developer-tool", "web-app"],
  ...
  { name:"nahwa-tafsir-mawdui", emoji:"🌊", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"nazarat-fi-al-quran", emoji:"📖", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"qadaya-al-marah", emoji:"🌹", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"🌹 Women's Issues — قضايا المرأة", fr:"Qadaya Al Marah — application éducative islamique trilingue.", ar:"قضايا المرأة" }},
  { name:"qadhaaif-al-haqq", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
    desc:{ en:"قذائف الحق — Missiles of Truth", fr:"Qadhaaif Al Haqq — application éducative islamique trilingue.", ar:"قذائف الحق" }},
  { name:"rakaiz-al-iman", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"ramadan-wal-siyam", emoji:"📖", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"rihlati-fikriyah", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "arabic", "web-app"],
  ...
  { name:"sayhah-tahdhir", emoji:"📖", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"shahid-ala-al-asr", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"taamulat", emoji:"🌿", categories:["tools"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "PWA", "developer-tool", "web-app"],
  ...
  { name:"tarbiyat-al-awlad", emoji:"📖", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
  ...
  { name:"zalam-min-al-gharb", emoji:"🕌", categories:["arabic"], badge:"stable", status:"stable", visibility:"public", tags:["HTML", "Islamic", "PWA", "arabic", "web-app"],
